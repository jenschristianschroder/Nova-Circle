...
export function Home() {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-nc-surface-background text-nc-content-primary">
        ...
        <div className="mx-auto flex max-w-5xl items-center px-nc-md py-nc-sm md:px-nc-lg">
          ...
          <nav aria-label="Primary navigation" className="ml-auto">
            <ul className="flex gap-nc-md">
              <li>
                <a href="#groups" className="text-nc-sm font-medium text-nc-content-secondary no-underline hover:text-nc-content-primary">Groups</a>
              </li>
              <li>
                <a href="#events" className="text-nc-sm font-medium text-nc-content-secondary no-underline hover:text-nc-content-primary">Events</a>
              </li>
            </ul>
          </nav>
        </div>
      ...
      {/* Main content */}
      <main id="main-content" className="mx-auto w-full max-w-5xl flex-1 px-nc-md py-nc-2xl md:px-nc-lg">
        <div className="flex flex-col gap-nc-2xl">
          {/* Hero */}
          <section aria-labelledby="hero-heading" className="flex flex-col items-center gap-nc-lg py-nc-3xl text-center">
            <h1 id="hero-heading" className="max-w-[28ch] text-[clamp(2rem,5vw,3.5rem)] font-bold leading-[1.15] tracking-tight">
          ...
          <section aria-labelledby="appearance-heading">
            <Card>
              <h2 id="appearance-heading" className="text-nc-xl font-semibold">Appearance</h2>
              <p className="mt-nc-xs text-nc-content-secondary">
                Currently: <strong>{resolvedMode} mode</strong> with <strong>{paletteId} palette</strong>
              </p>
          ...
          <section aria-labelledby="components-heading" className="flex flex-col gap-nc-lg">
            <h2 id="components-heading" className="text-nc-xl font-semibold">Component showcase</h2>
            ...
            <Card>
              ...
              <div className="flex flex-col gap-nc-sm">
                ...
                <p>Body text — system-ui. Nova-Circle keeps your events and group activity private. Only explicitly invited members can see event details.</p>
            ...
            <Card>
              ...
              <div className="grid grid-cols-2 gap-nc-sm sm:grid-cols-4" role="list" aria-label="Colour token swatches">
